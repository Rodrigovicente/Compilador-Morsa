...
#endif
/* Tokens.  */
#define TK_COM_SWITCH 258
#define TK_COM_DEFAULT 259
#define TK_OP_ARI 260
#define TK_OP_REL 261
#define TK_OP_LOG 262
#define TK_CAST 263
#define TK_BOOL 264
#define TK_ID 265
#define TK_NUM 266
...
#define TK_REAL 269
#define TK_TIPO 270
#define TK_TIPO_INFERIDO 271
#define TK_COM_IF 272
#define TK_COM_ELSE 273
#define TK_COM_WHILE 274
#define TK_COM_FOR 275
#define TK_COM_DO 276
#define TK_ATTR 277
...
{
       0,   250,   250,   257,   264,   269,   275,   283,   286,   287,
     291,   296,   300,   335,   350,   366,   374,   381,   388,   395,
     403,   445,   461,   489,   503
};
#endif
...
{
  "$end", "error", "$undefined", "TK_COM_SWITCH", "TK_COM_DEFAULT",
  "TK_OP_ARI", "TK_OP_REL", "TK_OP_LOG", "TK_CAST", "TK_BOOL", "TK_ID",
  "TK_NUM", "TK_CHAR", "TK_STRING", "TK_REAL", "TK_TIPO",
  "TK_TIPO_INFERIDO", "TK_COM_IF", "TK_COM_ELSE", "TK_COM_WHILE",
  "TK_COM_FOR", "TK_COM_DO", "TK_ATTR", "'='", "\"||\"", "\"&&\"",
  "\"==\"", "\"!=\"", "'<'", "'>'", "\">=\"", "\"<=\"", "'+'", "'-'",
  "'*'", "'/'", "'{'", "'}'", "';'", "'('", "')'", "$accept", "S",
  "INIT_BLOCO", "END_BLOCO", "BLOCO", "COMANDOS", "COMANDO", "E", "ATTR",
...
static const yytype_uint16 yytoknum[] =
{
     ...
     275,   276,   277,    61,   278,   279,   280,   281,    60,    62,
     282,   283,    43,    45,    42,    47,   123,   125,    59,    40,
      41
};
# endif
...
{
     -13,     5,   -11,   -13,    -3,   -13,     7,   -13,     2,   -13,
     -13,   -13,    17,    18,     7,    -8,    -3,    -4,    -7,   -12,
     -13,   -13,    15,     7,   -13,     8,    -5,   -13,   -13,     7,
       7,   -13,   -13,     7,   -13,    15,     7,   -13,    15,    15,
      15,    15
};
...
{
       3,     0,     0,     1,     7,     4,     0,    19,    15,    16,
      18,    17,     0,     0,     0,     0,     7,     0,     0,     0,
       2,    15,    14,    22,    23,     0,     0,     5,     6,     0,
       0,     8,    10,     0,     9,    20,     0,    11,    12,    13,
      21,    24
};
...
{
     -13,   -13,   -13,   -13,   -13,    21,   -13,     9,   -13,   -13
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     1,     2,    20,     5,    15,    16,    17,    18,    19
};
...
{
      29,    29,    30,    30,     6,     3,     7,     8,     9,    10,
      33,    11,    12,    13,     6,    22,     7,    21,     9,    10,
      29,    11,    30,    26,    23,     4,    34,    24,    25,    27,
      36,    32,    35,     0,    31,    37,    14,    28,    38,    39,
       0,     0,    40,     0,     0,    41,    14
};

static const yytype_int8 yycheck[] =
{
       5,     5,     7,     7,     7,     0,     9,    10,    11,    12,
      22,    14,    15,    16,     7,     6,     9,    10,    11,    12,
       5,    14,     7,    14,    22,    36,    38,    10,    10,    37,
      22,    38,    23,    -1,    38,    40,    39,    16,    29,    30,
      -1,    -1,    33,    -1,    -1,    36,    39
};
...
{
       0,    42,    43,     0,    36,    45,     7,     9,    10,    11,
      12,    14,    15,    16,    39,    46,    47,    48,    49,    50,
      44,    10,    48,    22,    10,    10,    48,    37,    46,     5,
       7,    38,    38,    22,    38,    48,    22,    40,    48,    48,
      48,    48
};
...
#line 301 "sintatica.y" /* yacc.c:1646  */
    {
				// + - * /
				(yyval).label = cria_nome_var();
				(yyval).traducao = (yyvsp[-2]).traducao + (yyvsp[0]).traducao;

				// para numeros
				if(((yyvsp[-2]).tipo_var == "int" || (yyvsp[-2]).tipo_var == "float") && ((yyvsp[0]).tipo_var == "float" || (yyvsp[0]).tipo_var == "int")){
					if((yyvsp[-2]).tipo_var == (yyvsp[0]).tipo_var){
						(yyval).tipo_var = (yyvsp[-2]).tipo_var;
						(yyval).traducao += (yyval).tipo_var + " " + (yyval).label + "; \n" + (yyval).label + " = " + (yyvsp[-2]).label + " " + (yyvsp[-1]).label + " " + (yyvsp[0]).label + "; \n";
					} else{
						(yyval).tipo_var = "float";
						if((yyvsp[-2]).tipo_var == "float"){
							string aux_var = cria_nome_tmp();
							(yyval).traducao += "float " + aux_var + "; \n" + aux_var + " = (float) " + (yyvsp[0]).label + "; \n";
							(yyval).traducao += "float " + (yyval).label + "; \n" + (yyval).label + " = " + (yyvsp[-2]).label + " " + (yyvsp[-1]).label + " " + aux_var + "; \n";
						} else{
							string aux_var = cria_nome_tmp();
							(yyval).traducao += "float " + aux_var + "; \n" + aux_var + " = (float) " + (yyvsp[-2]).label + "; \n";
							(yyval).traducao += "float " + (yyval).label + "; \n" + (yyval).label + " = " + aux_var + " " + (yyvsp[-1]).label + " " + (yyvsp[0]).label + "; \n";
						}
					}
                }
              	// para char e string (concatenacao)
              	else if(((yyvsp[-2]).tipo_var == "char" || (yyvsp[-2]).tipo_var == "char*") && ((yyvsp[0]).tipo_var == "char" || (yyvsp[0]).tipo_var == "char*")){
                	if((yyvsp[-1]).label == "+"){
...
#line 336 "sintatica.y" /* yacc.c:1646  */
    {
				...
				if((yyvsp[-2]).tipo_var == "bool" && (yyvsp[0]).tipo_var == "bool" && (yyvsp[-1]).label != "!"){
                	(yyval).traducao += "bool " + (yyval).label + "; \n" + (yyval).label + " = " + (yyvsp[-2]).label + " " + (yyvsp[-1]).label + " " + (yyvsp[0]).label + "; \n";
				} else{
                    if((yyvsp[-1]).label != "!"){
...
#line 351 "sintatica.y" /* yacc.c:1646  */
    {
				...
				if((yyvsp[-1]).tipo_var == "bool" && (yyvsp[0]).label == "!"){
...
#line 367 "sintatica.y" /* yacc.c:1646  */
    {
				(yyval) = mapaGetVar((yyvsp[0]));
				if((yyval).label == "!morsa"){
...
#line 375 "sintatica.y" /* yacc.c:1646  */
    {
				...
				(yyval).label = cria_nome_var();
              	(yyval).tipo_var = "int";
				(yyval).traducao = (yyvsp[0]).tipo_var + " " + (yyval).label + "; \n" + (yyval).label + " = " + (yyvsp[0]).label + "; \n";
			}
				...
				if((yyval).label == "!morsa"){
					...
					if((yyvsp[-1]).label == "="){
						...
						*/
						...
						if(((yyvsp[-2]).tipo_var == "int" || (yyvsp[-2]).tipo_var == "float") && ((yyvsp[0]).tipo_var == "int" || (yyvsp[0]).tipo_var == "float")){
							if((yyvsp[-1]).label == "*="){
								(yyval).traducao = (yyvsp[0]).traducao;
								(yyval).traducao += (yyval).label + " = " + (yyval).label + " * " + (yyvsp[0]).label + "; \n";
...
#line 462 "sintatica.y" /* yacc.c:1646  */
    {
				...
				(yyval) = mapaGetVar((yyvsp[-1]));

				if((yyval).label == "!morsa"){
					yyerror("ERRO: Não existe uma variável com este nome.");
				} else{
					if((yyvsp[0]).label == "++"){
						if((yyval).tipo_var == "int" || (yyval).tipo_var == "float"){
							(yyval).traducao = (yyval).label + " = " + (yyval).label + " + 1; \n";
						} else{
							yyerror("ERRO: A variável não é do tipo numérico (int ou float)");
						}

					} else if((yyvsp[0]).label == "--"){
						if((yyval).tipo_var == "int" || (yyval).tipo_var == "float"){
							(yyval).traducao = (yyval).label + " = " + (yyval).label + " - 1; \n";
						} else{
							yyerror("ERRO: A variável não é do tipo numérico (int ou float)");
...
#line 490 "sintatica.y" /* yacc.c:1646  */
    {
				...
				if((yyval).label == "!morsa"){
					(yyval).tipo_var = (yyvsp[-1]).label;
					(yyval).nome_var = (yyvsp[0]).label;
					(yyval).label = cria_nome_var();
          			(yyval).traducao = (yyval).tipo_var + " " + (yyval).label + "; \n";
					mapasAddVar((yyval));
				} else{
...
#line 504 "sintatica.y" /* yacc.c:1646  */
    {
				if((yyvsp[-1]).label == "="){
					...
					if((yyval).label == "!morsa"){
						(yyval).nome_var = (yyvsp[-2]).label;
						(yyval).label = cria_nome_var();
	          			(yyval).tipo_var = (yyvsp[0]).tipo_var;
						(yyval).traducao = (yyvsp[0]).traducao;
	                    (yyval).traducao += (yyval).tipo_var + " " + (yyval).label + "; \n" + (yyval).label + " = " + (yyvsp[0]).label + "; \n";
						mapasAddVar((yyval));
					} else{
...
#line 528 "sintatica.y" /* yacc.c:1906  */
